...
(with-eval-after-load 'view
  ...
  (define-key view-mode-map (kbd "C-w") 'View-scroll-page-backward-set-page-size) ;; view-mode显然不能编辑
  (define-key view-mode-map (kbd "C-SPC") 'View-scroll-page-forward-set-page-size);; 原C-spc是set-mark
  (define-key view-mode-map (kbd "C-v") 'View-scroll-page-forward-set-page-size);; view-mode显然不能编辑
