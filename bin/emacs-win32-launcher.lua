...
then
   emacsclientw = "C:\\green\\emacs\\gccemacs_230327\\bin\\emacsclientw.exe"
   runemacs = "C:\\green\\emacs\\gccemacs_230327\\bin\\runemacs.exe"
end
...
then
   emacsclientw = "c:\\green\\Emacs\\gccemacs_230627\\bin\\emacsclientw.exe"
   runemacs = "c:\\green\\Emacs\\gccemacs_230627\\bin\\runemacs.exe"
end
